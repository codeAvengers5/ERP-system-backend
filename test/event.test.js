...
describe('Appointment Controller', () => {
  ...
  describe('getUserAppointment', () => {
    ...
    it('should return a 500 error if there is an error getting the appointments', async () => {
      ...
      expect(res.status).toHaveBeenCalledWith(500);
      expect(res.json).toHaveBeenCalledWith({ error: 'Failed to get appointments' });
    });
  });
  ...
  describe('deleteAppointment', () => {
    ...
    it('should return 401 if appointment is paid', async () => {
      ...
      AppointedEvent.findById.mockResolvedValueOnce(appointment);
      AppointedEvent.findByIdAndDelete.mockResolvedValueOnce(appointment);
      ...
      expect(AppointedEvent.findByIdAndDelete).not.toHaveBeenCalled();
    });
